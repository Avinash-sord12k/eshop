...
export const POST = async (req) => {
  try {
    ...
    //               <a href="${process.env.CURRENT_DOMAIN}/auth/verify-user-token?token=${verificationToken}&email=${email}" style="font-size: 16px; color: #00bcd4; text-decoration: none;">Verify Email</a>
